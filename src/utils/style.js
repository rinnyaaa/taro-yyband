 ...
 * @param {*} showTabBar
 */
export function getWindowHeight(showTabBar = true, percent = 1,modify=0) {
  ...
  if (process.env.TARO_ENV === 'h5') {
    return `${(windowHeight - tabBarHeight+modify)*percent}px`
  }
  ...
  return `${(windowHeight+modify)*percent}px`
}
